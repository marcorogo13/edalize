            ...
            cocotb_options = {
                ...
                "verilator": (
                    ...
                    [
                        ...
                        '-LDFLAGS "-Wl,-rpath,`cocotb-config --lib-dir` -L`cocotb-config --lib-dir` -lcocotbvpi_verilator -lgpi -lcocotb -lgpilog -lcocotbutils  -Wl,--unresolved-symbols=ignore-all"',
                    ],
                ),
            }
